	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary"
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li><a href="../main/main_index.html">운동 추천</a></li>
					<li class="colorlib-active"><a href="../main/pt_academy.html">트레이너
							/ 체육관</a></li>
					<li><a href="../main/youtube.html">추천 영상</a></li>
					<li><a href="../main/calendar.html">캘린더</a></li>
					<li><a href="../main/survey.html">설문조사 다시하기</a></li>
					<li><a href="../main/update_member.html">개인정보수정</a></li>
				</ul>
			</nav>
						...
						<div class="col-md-4">
							<div class="blog-entry ftco-animate">
								...
								<div class="text text-2 pt-2 mt-3">
									...
									ArrayList<PtDTO> pt_list = new PtDAO().showPt(id); %>
									
									<h3 class="mb-4"><%= pt_list.get(0).getPtname()%></h3>
									
									<!-- 트레이너 주소(구) -->
									<p class="mb-4">트레이너 주소(구)</p>
						...
						<div class="col-md-4">
							<div class="blog-entry ftco-animate">
								...
								<div class="text text-2 pt-2 mt-3">
									...
									<!-- 트레이너 이미지 -->
									<!-- 트레이너 이름 -->
									<h3 class="mb-4">트레이너 이름</h3>
