...
<body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary"
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					...
					<li class="colorlib-active"><a href="../main/survey.html">설문조사다시하기</a></li>

					<li><a href="../main/calendar.html">캘린더</a></li>
					<li class="colorlib-active"><a href="../main/survey.html">설문조사 다시하기</a></li>
		...
		<div id="colorlib-main">
			...
			<div class="wrapper">
				<div class="title">
					<h3 class="main_title">맞춤형 운동 추천</h3>
					<h3 class="sub_title">헬스/요가/필라테스/크로스핏/홈트레이닝</h3>
				</div>
				<div class="intro">
					<h1>나의 운동 유형은?</h1>
					<div class="type">
				...
				<!-- 설문조사 form으로 이동하는 버튼(설문시작) -->
				<div class="button">
					<a href="./survey_form.html">
						<button class="start_Btn" type="button">시작하기</button>
					</a>
				</div>
