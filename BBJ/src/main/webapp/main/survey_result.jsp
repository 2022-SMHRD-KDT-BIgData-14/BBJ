...
<html lang="en">
  <head>
    ...
    <!-- survey-result.html css 연결 -->
    <title>나의 운동 유형 찾기</title>
	<link rel="stylesheet" href="../survey/css/reset.css">
	<link rel="stylesheet" href="../survey/css/result.css">
  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="../main/main_index.jsp"><img src="../main/images/BBJ_logo_grey.png" width="200px" height="200px"></a></h1>
...
>>>>>>> branch 'master' of https://github.com/2022-SMHRD-KDT-BIgData-14/BBJ.git
		...
		<div class="wrapper">
			<div class="result">
				<div class="titles">
					<h3>맞춤형 운동은!?</h3>
					<h1 style="padding-top:20px; padding-bottom:20px">추천받은 운동 종목</h1>
				</div>
			...
			<!-- <div class="lectures">
				<h3 class="title">운동 추천</h3>
				<ul>
					<li><a href="../main/main_index.jsp" target="_blank"> <img
							src="../main/images/BBJ_logo_grey.png" alt="BBJ">
							<h3>Python 부트캠프</h3>
							<button type="button">추천 서비스 이용하기</button>
					</a></li>
				</ul>
			</div> -->
			...
			<div class="buttons">
				<ul>
					<li>
						<a href="./survey.jsp">
							<button class="restart" type="button">설문조사 다시하기</button>
						</a>
					</li>
			...
			<div class="weniv">
				<!--  <a href="http://www.paullab.co.kr"> <img
					src="../img/weniv_logo_black.png" alt="weniv" />
				</a> -->
			</div>
			<p>배부르조 운동하조</p>
			<p>BBJ</p>
