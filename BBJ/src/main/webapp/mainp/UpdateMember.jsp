...
<body style="text-align: center;">
	...
	<div id="wrapper">
		...
		<ul class="actions vertical">
			...
			<form action="UpdateService.do" method="post">
				...
				<li><input type="hidden" name="id" value="<%=info.getId()%>">
				<li><input type="submit" value="pdate" class="button fit"
					style="width: 500px; margin: 0 auto;"></li>
			</form>
		</ul>
		</nav>
	...
	<!-- Scripts -->
	<script src="../mainp/js/jquery.min.js"></script>
	<script src="../mainp/js/jquery.scrolly.min.js"></script>
	<script src="../mainp/js/jquery.scrollex.min.js"></script>
	<script src="../mainp/js/skel.min.js"></script>
	<script src="../mainp/js/util.js"></script>
	<!--[if lte IE 8]><script src="assets/js/ie/respond.min.js"></script><![endif]-->
	<script src="../mainp/js/main.js"></script>
</body>
</html>
